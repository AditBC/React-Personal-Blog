  ...
  return (
    <Router>
      <div className="container">
          ...
          <nav>
            <ul className="nav-links">
              ...
              <li className="dropdown">
                <Link to="/" className='dropbtn'>Reviews</Link>
        ...
        <Routes>
          <Route path="/" element={<HomePage articles={filteredArticles} />} />
          <Route path="/article/:id" element={<ArticleDetail articles={filteredArticles} />} />
        </Routes>
      </div>
    </Router>
  );
